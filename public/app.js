  ...
  try {
    ...
    initializeApp({
      ...
      translations: {
        ...
        urlLabel: "Video URL",
        urlPlaceholder:
          "https://... (YouTube, TikTok, Twitter, Instagram, etc.)",
        formatLabel: "Format",
        ...
        noteCleanup:
          "Each file is automatically deleted after download or 15 minutes.",
...
function initializeApp(config) {
  ...
  document.getElementById("download-button-text").textContent =
    t.downloadButton;
  ...
  formatSelect.innerHTML = `
    ...
    <option value="wav">${t.formatWav || "WAV (audio)"}</option>
  `;
  ...
  document.getElementById("download-link-text").textContent =
    t.downloadLinkText;
  document.getElementById("playlist-content-text").textContent =
    t.playlistContent;
